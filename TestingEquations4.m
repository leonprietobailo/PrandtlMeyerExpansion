...
while(xi < xMax)
    ...
    for ve=1:j
        ...
        if ve == 1
            ...
            F1(ve,ho+1) = ro(ve,ho+1) * u(ve,ho+1);
            F2(ve,ho+1) = ro(ve,ho+1) * u(ve,ho+1) ^ 2 + p(ve,ho+1);
            F3(ve,ho+1) = ro(ve,ho+1) * u(ve,ho+1) * v(ve,ho+1);
            F4(ve,ho+1) = gamma / (gamma - 1) * p(ve,ho+1)*u(ve,ho+1) + ro(ve,ho+1)*u(ve,ho+1)*(u(ve,ho+1)^2 + v(ve,ho+1)^2) / 2;
        end
